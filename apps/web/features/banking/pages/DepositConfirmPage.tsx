...
export const DepositConfirmPage = () => {
  ...
  const handleOnSubmit = async (data: any) => {
    ...
    setLoaderBackdrop(true, {
      title: MESSAGES.dashboard.banking.stepper.deposit.loader.title,
      description: MESSAGES.dashboard.banking.stepper.deposit.loader.description,
    });
  ...
  return (
    <ContainerUI className="flex flex-col gap-10 h-full">
      ...
      >
        {MESSAGES.dashboard.banking.stepper.deposit.confirm}
      </TypographyUI>
      ...
      <TransactionConfirmBanking
        ...
        messageAlert={MESSAGES.dashboard.banking.alert.warningDeposit}
      />
    </ContainerUI>
  );
};
