...
import { NotFoundProduct } from "@/features/banking/components/NotFoundProduct";
import { dashboardRoutes } from "@/entry-point/config/routes.config";
import { PartialPaymentBanking } from "../components/PartialPayment";
...
export const PaymentFormPage = () => {
  ...
  if(selectPartial) {
    return <PartialPaymentBanking header={{ title: "Total", subtitle: "Rp 1.000.000" }} />;
  }
  ...
  return (
    <ContainerUI className="flex flex-col gap-10 h-full justify-center">
      ...
      >
        {MESSAGES.dashboard.banking.stepper.payment.form}
      </TypographyUI>
